...
// per-call counters beside it, from the shared collector the harness arms.
    ...
    try {
      harness = await startRealAiHarness(
        ...
        {},
        {
          ...
          enableStreaming: false,
          thinkingMode: "off",
          // Generous request timeout keeps structured planning at its full
          // cap; see the adaptive-orchestration-guide scenario above.
          requestTimeoutMs: 150_000,
          maxRunMinutes: 4,
          maxAgentSteps: 16,
          orchestratorWorkerMaxSteps: 6,
