 ...
 * metrics. One authority (the runPlanSharedClassifiers convention): a private
 * copy in a consumer is a second seat that will drift, and the drift mode
 * here is exactly the bug family this wave removes — unknown collapsing into
 * an explicit zero. tests/toolCallCensus.test.ts guards against re-inlining.
 */
 ...
 * of the known values (an explicit lower bound).
 */
