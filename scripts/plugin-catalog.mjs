...
export const PLUGIN_CATALOG = Object.freeze([
  ...
  Object.freeze({
    ...
    sourceDir: "extensions/code",
    entry: "extensions/code/main.ts",
    outfile: "extensions/code/main.js",
  ...
  Object.freeze({
    ...
    sourceDir: "extensions/integrations",
    entry: "extensions/integrations/main.ts",
    outfile: "extensions/integrations/main.js",
    expectedVersion: "0.2.0",
    desktopOnly: true,
    required: false,
  }),
  Object.freeze({
    ...
    sourceDir: "extensions/companion",
    entry: "extensions/companion/main.ts",
    outfile: "extensions/companion/main.js",
    expectedVersion: "0.2.0",
    desktopOnly: true,
    required: false,
  }),
