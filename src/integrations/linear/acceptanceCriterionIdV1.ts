 ...
 *
 * Three separate validators each carried their own copy of `/^AC-[1-9][0-9]?$/`
 * (AcceptedResearchArtifactV1, AcceptedResearchNoteWriter, WorkItemSpecV1).
 * Three copies of one rule is the precondition of the drift this codebase keeps
 * paying for, so the pattern, the canonical test, and the tolerant normalizer
 * all live here and every seat consumes them.
 *
 ...
 * "AC-1" and "ac-01" colliding, which three separate regexes could not.
 *
